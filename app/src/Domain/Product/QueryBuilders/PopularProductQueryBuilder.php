 ...
 */
class PopularProductQueryBuilder extends BaseQueryBuilder
{
    ...
    {
        return $this->join('products', 'popular_products.product_id', '=', 'products.id')->leftJoin('product_store as leftovers', 'leftovers.product_system_id', '=', 'products.system_id')
