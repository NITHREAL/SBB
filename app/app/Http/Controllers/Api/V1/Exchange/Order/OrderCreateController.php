...
class OrderCreateController extends BaseOrderController
{
    ...
    public function exchangeCollection(
        ...
        Log::channel('exchange.order')->info('Processing order creating collection exchange', $request->all());
    ...
    public function exchange(OrderItemRequest $request): Order
    {
        ...
        $orderDTO = OrderCreateExchangeDTO::make($data);

        $order = $this->orderExchangeUpdateService->createOrder($orderDTO);
