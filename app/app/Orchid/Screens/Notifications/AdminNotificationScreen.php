...
namespace App\Orchid\Screens\Notifications;

use App\Orchid\Layouts\User\Notification\AdminNotificationListLayout;
...
class AdminNotificationScreen extends Screen
{
     ...
     * @var string
     */
    public $description = 'Важные события, за которыми вы следите';
    ...
    {
        return [
            AdminNotificationListLayout::class,
        ];
    }
