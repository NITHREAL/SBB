<div class="d-inline-block">
    <div class="d-flex align-items-center rounded overflow-hidden">
        @if($image)
            <img class="mw-100" src="{{$image->relativeUrl}}?w=75&h=50" alt="">
        @else
            <div class="mw-100">
                <svg id="Icons" height="50" viewBox="0 0 74 74" width="50" xmlns="http://www.w3.org/2000/svg" fill="#21252959">
